...
public abstract class Insurance {
    ...
    class InsuranceManager{
        ...
        public Insurance createInsurance(User user){
            ...
            if (choice.equals("1")) return new HealtInsurance("Health Insurance",1.98,Date.from(Instant.now()), user);
            if (choice.equals("2")) return new ResidanceInsrance("Residence Insurance",1.46,Date.from(Instant.now()),user);
